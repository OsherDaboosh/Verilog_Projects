...
module sobel_control (
    ...
    localparam  IDLE = 'b0, READ_BUFFER = 'b1;
    ...
    always @(posedge clk) begin
        ...
        else if (pixelCounter == 511 & in_tvalid)
    ...
    always @(posedge clk) begin
        ...
        else if (rdCounter == 511 & rdLineBuffer)
    ...
    always @(*) begin
        case (currentRdLineBuffer)
            0: begin
                out_data = {lB2data,lB1data,lB0data};
            end
            1: begin
                out_data = {lB3data,lB2data,lB1data};
            end
            2: begin
                out_data = {lB0data,lB3data,lB2data};
            end
            3: begin
                out_data = {lB1data,lB0data,lB3data};
            end
        endcase
    end
