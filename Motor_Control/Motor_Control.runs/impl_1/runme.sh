...
HD_PWD='C:/Users/osher/Verilog_Projects/Motor_Control/Motor_Control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dc_motor_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dc_motor_control.tcl -notrace
