...
HD_PWD='C:/Users/osher/Verilog_Projects/Motor_Control/Motor_Control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dc_motor_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dc_motor_control.tcl
