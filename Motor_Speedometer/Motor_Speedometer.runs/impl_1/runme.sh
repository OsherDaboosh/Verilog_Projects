...
HD_PWD='C:/Users/osher/Verilog_Projects/Motor_Speedometer/Motor_Speedometer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log speedometer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source speedometer_top.tcl -notrace
