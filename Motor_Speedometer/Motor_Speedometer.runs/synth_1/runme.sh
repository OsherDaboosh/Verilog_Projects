...
HD_PWD='C:/Users/osher/Verilog_Projects/Motor_Speedometer/Motor_Speedometer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log speedometer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source speedometer_top.tcl
